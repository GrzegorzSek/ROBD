...
class Ui_ViewPartsWindow(object):
    def setupUi(self, ViewPartsWindow, sql_code, adress):
        p1 = main.DB(adress)
        ...
        self.tableWidget.setHorizontalHeaderLabels(["Nazwa", "Opis", "Model", "Marka", "Liczba Sztuk", "Magazyn"])
        for line in p1.cur:
            print(line)
            ...
            self.tableWidget.setItem(rows, 4, QTableWidgetItem(str(line[4])))
